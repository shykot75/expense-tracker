    ...
    <div class="min-h-screen flex flex-col justify-center px-6 py-12 lg:px-8 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500" x-data="{ loading: false, showPassword: false }">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[400px]">
            <div class="glass-card p-8 rounded-[2rem] shadow-2xl relative overflow-hidden">
                ...
                <div x-show="loading" x-transition.opacity class="absolute inset-0 bg-white/60 backdrop-blur-sm z-50 flex items-center justify-center">
                    <div class="flex flex-col items-center">
                        ...
                        <span class="text-xs font-bold text-indigo-600 uppercase tracking-widest">Authenticating...</span>
                    </div>
                </div>
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-6" @submit="loading = true">
                    ...
                    <div class="flex items-center justify-between px-1">
                        <div class="flex items-center">
                            ...
                            <label for="remember" class="ml-2 block text-sm font-bold text-slate-600">Remember me</label>
                        </div>
                        <div class="text-sm">
                ...
                <div class="mt-8">
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-sm font-bold leading-6">
                            <span class="bg-transparent px-6 text-slate-400 uppercase tracking-widest text-[10px]">Or continue with</span>
                        </div>
                    </div>

                    <div class="mt-6 grid grid-cols-1">
                        <a href="#" class="flex w-full items-center justify-center gap-3 rounded-2xl bg-white px-3 py-3 text-sm font-bold text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 hover:bg-slate-50 focus-visible:ring-transparent transition-all active:scale-95">
            ...
            <p class="mt-10 text-center text-sm text-white/90">
                ...
                <a href="{{ route('register') }}" class="font-bold leading-6 text-white hover:text-indigo-100 underline decoration-2 underline-offset-4">Create one for free</a>
            </p>
        </div>
    </div>
</x-app-layout>
